        ...
        private static string GetResourceDictionarySource(BaseTheme theme)
        {
            switch (theme)
            {
                case BaseTheme.Light:
                    return "pack://application:,,,/SpyGlass.Design;component/Themes/SpyGlass.Light.xaml";
                case BaseTheme.Dark:
                    return "pack://application:,,,/SpyGlass.Design;component/Themes/SpyGlass.Dark.xaml";
            }
            return null;
        }
    }
