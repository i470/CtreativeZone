...
namespace SpyGlass.Simulator
{
    public interface ISentinelService
    {
        ...
        Task TransportStateChangeEvent(Action<bool, Exception> callback, bool state, int speed);
        ...
        Task TransportALlMotorsStateChange(Action<bool, Exception> callback, bool state, int speed);
