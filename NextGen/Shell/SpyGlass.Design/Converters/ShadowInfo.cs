...
namespace SpyGlass.Design.Wpf.Converters
{
    internal static class ShadowInfo
    {
        ...
        static ShadowInfo()
        {
            var resourceDictionary = new ResourceDictionary { Source = new Uri("pack://application:,,,/SpyGlass.Design;component/Themes/SpyGlass.Shadows.xaml", UriKind.Absolute) };
